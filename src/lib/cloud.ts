...
export function rowToStock(r: Row): InventoryStock {
  return {
    ...
    customField1: (r.customfield1 as string) ?? undefined,
    customField2: (r.customfield2 as string) ?? undefined,
    customField3: (r.customfield3 as string) ?? undefined,
...
export function stockToRow(s: InventoryStock, userId: string) {
  return {
    ...
    hide_custom_field_1: s.hideCustomField1 ?? false,
    hide_custom_field_2: s.hideCustomField2 ?? false,
    hide_custom_field_3: s.hideCustomField3 ?? false,
  };
}
